...
alex_table = listArray (0 :: Int, 5661)
  [ 0
  , 53
  , 53
  , 53
...
alex_check = listArray (0 :: Int, 5661)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_13 = \p s -> Reference s p
alex_action_14 = \p s -> Reference s p
alex_action_15 = \p s -> Reference s p
...
alex_action_33 = \p s -> Character s p
alex_action_34 = \p s -> Integer (read s) p
alex_action_35 = \p s -> Character s p
alex_action_36 = \p s -> String s p
alex_action_37 = \p s -> File s p
alex_action_38 = \p s -> File s p
